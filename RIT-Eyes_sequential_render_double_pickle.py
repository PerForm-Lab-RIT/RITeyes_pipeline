...
#     pupil = [float(((x / 2) * (0.8 / 3)) - (0.5 / 3)) for x in pupil]
    ...
    other_eye = bpy.data.objects['other_eye']
    eye_delta = export_data['eye_delta']
    ...
    for x in range(1, frame_cap):
        ...
        # other eye
        other_eye_norm = export_data['other_pupil_normal'][x]
        other_eye_angle = angle_between_three_3D_points(other_eye_norm,[0,0,0],[0,0,1])

        #print('Other Eyeball normal: '+str(other_eye_norm))

        other_eye.rotation_euler[0] = math.radians(other_eye_angle[0])
        other_eye.rotation_euler[1] = math.radians(other_eye_angle[1])
        other_eye.rotation_euler[2] = math.radians(other_eye_angle[2])
        
        other_eye.location = [eye_delta[0] + eye_loc[0], eye_delta[1] + eye_loc[1], eye_delta[2] + eye_loc[2]]
