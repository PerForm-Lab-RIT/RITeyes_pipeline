...
def blink_render():
   ...
   # print ('here',e_x)
    ...
    for x in range(1, frame_cap):
        ...
        # Setting the rotation
        print()
        print('Eye rotation at frame: ' + str(x))
        print(e_z[x])
        print(e_x[x])
        print(e_y[x])
        print()
        ...
        eye.location[0] = -args.camera_distance[0]
        eye.location[1] = -args.camera_distance[1]
        eye.location[2] = -args.camera_distance[2]
       ...
       # upper_blink= max(math.radians(upper_org[0] - u_z[x]),math.radians(upper_blink_topvalue))
      #  lower_blink= max(math.radians(-lower_org[0] + l_z[x]),math.radians(lower_blink_bottomvalue))
...
#        lower_blink= np.clip(math.radians(-lower_org[0] + l_z[x]),math.radians(lower_blink_bottomvalue),30)
      #  lower_blink= -np.clip(math.radians(lower_org[0] - l_z[x]),math.radians(lower_blink_bottomvalue),math.radians(lower_blink_topvalue))
        ...
        upper_blinker.rotation_euler[0] = upper_blink#np.clip(math.radians(upper_org[0] - u_z[x]),math.radians(-10),math.radians(51.3))
        upper_blinker.rotation_euler[1] = 0
        upper_blinker.rotation_euler[2] = 0#math.radians(upper_org[2]+ u_y[x])
        upper_blinker.keyframe_insert(data_path="rotation_euler", frame=x)
        lower_blinker.rotation_euler[0] = lower_blink#np.clip(math.radians(lower_org[0] - l_z[x]),math.radians(-10.2),math.radians(10.6)) #-
        lower_blinker.rotation_euler[1] = 0 
        lower_blinker.rotation_euler[2] = 0#math.radians(lower_org[2]+ l_y[x]) #+
